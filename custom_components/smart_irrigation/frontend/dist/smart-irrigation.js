      ...
      <ha-dialog open .heading=${!0}>
        ...
        <div class="wrapper">
          <div class="dialog-help">
            ${$o("irrigation_start_triggers.dialog.help",this.hass.language)}
            <code>smart_irrigation_start_irrigation_all_zones</code>
          </div>
          <div class="form-group">
            <label class="form-label"
              >${$o("irrigation_start_triggers.fields.name.name",this.hass.language)}</label
            >
            <input
              class="form-input"
              type="text"
          ...
          <div class="form-group">
            <ha-select
              .label=${$o("irrigation_start_triggers.fields.type.name",this.hass.language)}
              .value=${this._trigger.type}
              @selected=${this._typeChanged}
            >
              <ha-dropdown-item value=${Me}>
                ${$o("irrigation_start_triggers.trigger_types.sunrise",this.hass.language)}
              </ha-dropdown-item>
              <ha-dropdown-item value=${"sunset"}>
                ${$o("irrigation_start_triggers.trigger_types.sunset",this.hass.language)}
              </ha-dropdown-item>
              <ha-dropdown-item value=${De}>
                ${$o("irrigation_start_triggers.trigger_types.solar_azimuth",this.hass.language)}
              </ha-dropdown-item>
            </ha-select>
          </div>
          ...
          <div class="form-group">
            <ha-formfield
              .label=${$o("irrigation_start_triggers.fields.enabled.name",this.hass.language)}
            >
              <ha-switch
          ...
          <div class="form-group">
            <label class="form-label"
              >${$o("irrigation_start_triggers.fields.offset_minutes.name",this.hass.language)}</label
            >
            <input
              class="form-input"
              type="number"
          ...
          <div class="form-group">
            <ha-formfield
              .label=${$o("irrigation_start_triggers.fields.account_for_duration.name",this.hass.language)}
            >
              <ha-switch
          ...
          ${this._trigger.type===De?q`
                <div class="form-group">
                  <label class="form-label"
                    >${$o("irrigation_start_triggers.fields.azimuth_angle.name",this.hass.language)}</label
                  >
                  <input
                    class="form-input"
                    type="number"
        ...
        <ha-dialog-footer slot="footer">
          ...
          >
            ${$o("irrigation_start_triggers.dialog.cancel",this.hass.language)}
          </ha-button>
          ${t?"":q`
                <ha-button
                  slot="secondaryAction"
                ...
                >
                  ${$o("irrigation_start_triggers.dialog.delete",this.hass.language)}
                </ha-button>
              `}
          <ha-button
            slot="primaryAction"
...
`;let sl=class extends(qo(ce)){constructor(){super(...arguments),this.isLoading=!0,this.isSaving=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null;return a=>{e&&clearTimeout(e),e=window.setTimeout((()=>{this.saveData(a),e=null}),500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:je+"_config_updated"})]}async _fetchData(){if(this.hass){this._hasLoadedOnce||(this.isLoading=!0,this._scheduleUpdate());try{this.config=await Lo(this.hass),this.data=(e=this.config,a=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","autoclearenabled","cleardatatime","continuousupdates","sensor_debounce","manual_coordinates_enabled","manual_latitude","manual_longitude","manual_elevation","days_between_irrigation",Ae,$e,Ee],e?Object.entries(e).filter((([e])=>a.includes(e))).reduce(((e,[a,t])=>Object.assign(e,{[a]:t})),{}):{})}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}var e,a}}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}render(){var e,a,t;if(!this.hass||!this.config||!this.data)return q`<div class="loading-indicator">
        ${$o("common.loading-messages.configuration",null!==(a=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==a?a:"en")}
      </div>`;if(this.isLoading)return q`<div class="loading-indicator">
        ${$o("common.loading-messages.general",this.hass.language)}
      </div>`;{let e=q` <div class="card-content">
          ${$o("panels.general.cards.automatic-duration-calculation.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${$o("panels.general.cards.automatic-duration-calculation.labels.auto-calc-enabled",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            ${this._timeRow($o("panels.general.cards.automatic-duration-calculation.labels.calc-time",this.hass.language),this.config.calctime,(e=>this.handleConfigChange({calctime:e})))}
          </div>`),e=q`<ha-card
        header="${$o("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}"
      >
        ${e}</ha-card
      >`;let a=q` <div class="card-content">
          ${$o("panels.general.cards.automatic-update.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${$o("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            <div class="setting-row">
              <div class="setting-label">
                ${$o("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}
              </div>
              <div class="combo-field">
                ...
                <div class="select-wrap">
                  ...
                  >
                    ...
                    >
                      ${$o("panels.general.cards.automatic-update.options.minutes",this.hass.language)}
                    </option>
                    <option
                      value="${Ne}"
                      ?selected=${this.data.autoupdateschedule===Ne}
                    >
                      ${$o("panels.general.cards.automatic-update.options.hours",this.hass.language)}
                    </option>
                    <option
                      value="${Pe}"
                      ?selected=${this.data.autoupdateschedule===Pe}
                    >
                      ${$o("panels.general.cards.automatic-update.options.days",this.hass.language)}
                    </option>
                  </select>
          ...
          <div class="card-content">
            ${this._numRow($o("panels.general.cards.automatic-update.labels.auto-update-delay",this.hass.language),"s",this.config.autoupdatedelay,(e=>this.saveData({autoupdatedelay:parseInt(e)})),1)}
          </div>`),a=q`<ha-card header="${$o("panels.general.cards.automatic-update.header",this.hass.language)}",
      this.hass.language)}">${a}</ha-card>`;let i=q` <div class="card-content">
          ${$o("panels.general.cards.automatic-clear.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${$o("panels.general.cards.automatic-clear.labels.automatic-clear-enabled",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            ${this._timeRow($o("panels.general.cards.automatic-clear.labels.automatic-clear-time",this.hass.language),this.config.cleardatatime,(e=>this.handleConfigChange({cleardatatime:e})))}
          </div>`),i=q`<ha-card
        header="${$o("panels.general.cards.automatic-clear.header",this.hass.language)}"
        >${i}</ha-card
      >`;let n=q`<div class="card-content">
          ${$o("panels.general.cards.continuousupdates.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${$o("panels.general.cards.continuousupdates.labels.continuousupdates",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            ${this._numRow($o("panels.general.cards.continuousupdates.labels.sensor_debounce",this.hass.language),"ms",this.config.sensor_debounce,(e=>this.handleConfigChange({sensor_debounce:parseInt(e)})),1)}
          </div>`),n=q`<ha-card
        header="${$o("panels.general.cards.continuousupdates.header",this.hass.language)}"
        >${n}</ha-card
      > `;const r=this.renderMasterSwitchCard(),s=this.renderTriggersCard(),o=this.renderWeatherSkipCard(),l=this.renderCoordinateCard(),d=this.renderDaysBetweenIrrigationCard(),u=this.renderObservedWateringCard();return q`<ha-card
          header="${$o("panels.general.title",this.hass.language)}"
        >
          <div class="card-content">
            ${$o("panels.general.description",this.hass.language)}
          </div> </ha-card
         >${r}${a}${e}${i}${n}${s}${o}${l}${d}${u}`}}renderTriggersCard(){if(!this.config||!this.data||!this.hass)return q``;const e=this.config.irrigation_start_triggers||[];return q`
      <ha-card
        header="${$o("irrigation_start_triggers.title",this.hass.language)}"
      >
        <div class="card-content">
          ${$o("irrigation_start_triggers.description",this.hass.language)}
        </div>

        <div class="card-content trigger-usage">
          ${$o("irrigation_start_triggers.usage_before",this.hass.language)}
          <code>smart_irrigation_start_irrigation_all_zones</code>${$o("irrigation_start_triggers.usage_after",this.hass.language)}
        </div>

        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${$o("irrigation_start_triggers.active_label",this.hass.language)}
            </div>
            <select
              class="field"
            ...
            >
              ...
              >
                ${$o("irrigation_start_triggers.active_default",this.hass.language)}
              </option>
              ${e.map((e=>q`
                  <option
                    value="${e.name}"
          ...
          <div class="trigger-active-hint">
            ${$o("irrigation_start_triggers.active_hint",this.hass.language)}
          </div>
        </div>
          ...
          <div class="triggers-list">
            ${0===e.length?q`
                  <div class="no-triggers">
                    ${$o("irrigation_start_triggers.no_triggers",this.hass.language)}
                  </div>
                `:e.map(((e,a)=>this.renderTriggerItem(e,a)))}
          </div>

          <div class="add-trigger-section">
            ${this._actionBtn(Xo,$o("irrigation_start_triggers.add_trigger",this.hass.language),(()=>this._addTrigger()))}
          </div>
        </div>
      </ha-card>
    `}renderTriggerItem(e,a){if(!this.hass)return q``;const t=$o(`irrigation_start_triggers.trigger_types.${e.type}`,this.hass.language);let i="";if(e.type===Me&&0===e.offset_minutes)i=$o("irrigation_start_triggers.offset_auto",this.hass.language);else{const a=Math.abs(e.offset_minutes),t=Math.floor(a/60),n=a%60,r=e.offset_minutes<0?$o("common.labels.before",this.hass.language):$o("common.labels.after",this.hass.language);i=t>0?`${t}h ${n}m ${r}`:`${n}m ${r}`}let n="";return e.type===De&&void 0!==e.azimuth_angle&&(n=` (${e.azimuth_angle}°)`),q`
      <div class="trigger-item ${e.enabled?"enabled":"disabled"}">
        <div class="trigger-main">
          ...
          <div class="trigger-status">
            ${e.enabled?$o("common.labels.enabled",this.hass.language):$o("common.labels.disabled",this.hass.language)}
          </div>
        </div>
        ...
        <div class="card-content">
          <div class="setting-row">
            ...
            <ha-entity-picker
              ...
              @value-changed=${e=>{var a;return this.handleConfigChange({[Ae]:(null===(a=e.detail)||void 0===a?void 0:a.value)||null})}}
            ></ha-entity-picker>
          </div>
        </div>
      </ha-card>
    `}renderWeatherSkipCard(){return this.config&&this.data&&this.hass?q`
      <ha-card header="${$o("weather_skip.title",this.hass.language)}">
        <div class="card-content">
          ${$o("weather_skip.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${$o("weather_skip.title",this.hass.language)}
            </div>
            <ha-switch
          ...
          ${this.config.skip_irrigation_on_precipitation?this._numRow($o("weather_skip.threshold_label",this.hass.language),Po(this.config,Se),this.config.precipitation_threshold_mm,(e=>this.handleConfigChange({precipitation_threshold_mm:parseFloat(e)})),.1):""}
        </div>
      </ha-card>
    `:q``}renderObservedWateringCard(){var e;if(!this.config||!this.data||!this.hass)return q``;const a=this.hass.language;return q`
      <ha-card header="${$o("observed_watering.title",a)}">
        <div class="card-content">
          ${$o("observed_watering.description",a)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${$o("observed_watering.enabled_label",a)}
            </div>
            <ha-switch
          ...
          <div class="setting-row">
            <div class="setting-label">
              ${$o("observed_watering.direct_control_label",a)}
            </div>
            <ha-switch
          ...
          ${this.config.direct_valve_control_enabled?q`
                <div class="card-content">
                  ${$o("observed_watering.direct_control_description",a)}
                </div>
                <div class="setting-row">
                  <div class="setting-label">
                    ${$o("observed_watering.sequencing_label",a)}
                  </div>
                  <select
                    class="field"
                  ...
                  >
                    ...
                    >
                      ${$o("observed_watering.sequencing.sequential",a)}
                    </option>
                    <option
                      value="parallel"
                      ?selected=${"parallel"===this.config.zone_sequencing}
                    >
                      ${$o("observed_watering.sequencing.parallel",a)}
                    </option>
                    </select>
                </div>
                ${"sequential"===this.config.zone_sequencing?q`
                      <div class="setting-row">
                        <div class="setting-label">
                          ${$o("observed_watering.transition_delay_label",a)}
                          <div class="setting-hint">
                            ${$o("observed_watering.transition_delay_description",a)}
                          </div>
                        </div>
                        <input
                          class="field combo-num"
                          ...
                          min="0"
                          step="1"
                          .value=${String(null!==(e=this.config.zone_transition_delay)&&void 0!==e?e:0)}
                          @change=${e=>this.handleConfigChange({[Ee]:Math.max(0,parseInt(e.target.value,10)||0)})}
                        />
                      </div>
                    `:""}
                <div class="setting-row">
                  <div class="setting-label">
                    ${$o("observed_watering.master_valve_label",a)}
                    <div class="setting-hint">
                      ${$o("observed_watering.master_valve_description",a)}
                    </div>
                  </div>
                  <ha-entity-picker
                    class="entity-field"
                    ...
                    .includeDomains=${["switch","input_boolean"]}
                    @value-changed=${e=>{var a;return this.handleConfigChange({[$e]:(null===(a=e.detail)||void 0===a?void 0:a.value)||null})}}
                  ></ha-entity-picker>
                </div>
              `:""}
        </div>
    ...
    `}renderCoordinateCard(){if(!this.config||!this.data||!this.hass)return q``;const e=this.hass.config,a=(null==e?void 0:e.latitude)||0,t=(null==e?void 0:e.longitude)||0,i=(null==e?void 0:e.elevation)||0;return q`
      <ha-card
        header="${$o("coordinate_config.title",this.hass.language)}"
      >
        <div class="card-content">
          ${$o("coordinate_config.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${$o("coordinate_config.manual_enabled",this.hass.language)}
            </div>
            <ha-switch
            ...
            ${this.data.manual_coordinates_enabled?q`
                    ${this._numRow($o("coordinate_config.latitude",this.hass.language),"",this.data.manual_latitude||a,(e=>this.handleConfigChange({manual_latitude:parseFloat(e)})),.1)}
                    ${this._numRow($o("coordinate_config.longitude",this.hass.language),"",this.data.manual_longitude||t,(e=>this.handleConfigChange({manual_longitude:parseFloat(e)})),.1)}
                    ${this._numRow($o("coordinate_config.elevation",this.hass.language),"",this.data.manual_elevation||i,(e=>this.handleConfigChange({manual_elevation:parseFloat(e)})),1)}
                  `:q`
                    <div
                      class="zoneline"
                      style="color: var(--secondary-text-color); font-style: italic;"
                    >
                      ${$o("coordinate_config.current_ha_coords",this.hass.language)}:<br />
                      ${$o("coordinate_config.latitude",this.hass.language)}:
                      ${a}<br />
                      ${$o("coordinate_config.longitude",this.hass.language)}:
                      ${t}<br />
                      ${$o("coordinate_config.elevation",this.hass.language)}:
                      ${i}m
                    </div>
                  `}
                </div>
    ...
    `}renderDaysBetweenIrrigationCard(){return this.config&&this.data&&this.hass?q`
      <ha-card
        header="${$o("days_between_irrigation.title",this.hass.language)}"
      >
        <div class="card-content">
          ${$o("days_between_irrigation.description",this.hass.language)}
        </div>

        <div class="card-content">
          ${this._numRow($o("days_between_irrigation.label",this.hass.language),"",this.config.days_between_irrigation||0,(e=>this.handleConfigChange({days_between_irrigation:parseInt(e)})),1)}
          <div class="card-content">
            <div
              style="color: var(--secondary-text-color); font-size: 0.875rem; margin-top: 8px;"
            >
              ${$o("days_between_irrigation.help_text",this.hass.language)}
            </div>
          </div>
        </div>
      </ha-card>
    `:q``}async saveData(e){if(this.hass&&this.data){this.isSaving=!0,this._scheduleUpdate(),this._suppressNextConfigUpdate=!0;try{this.data=Object.assign(Object.assign({},this.data),e),this.config=Object.assign(Object.assign({},this.config),e),this._scheduleUpdate(),await(a=this.hass,t=this.data,a.callApi("POST",je+"/config",t))}catch(e){this._suppressNextConfigUpdate=!1,console.error("Error saving config:",e),Ho(e,this.shadowRoot.querySelector("ha-card")),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}var a,t}}handleConfigChange(e){this.debouncedSave(e)}disconnectedCallback(){super.disconnectedCallback()}_textRow(e,a,t,i){return q`
      <div class="setting-row">
        <div class="setting-label">
...
t.version="2.30.1",i(Gt),t.fn=or,t.min=Jt,t.max=Qt,t.now=Xt,t.utc=m,t.unix=lr,t.months=hr,t.isDate=u,t.locale=mt,t.invalid=f,t.duration=Si,t.isMoment=z,t.weekdays=fr,t.parseZone=dr,t.localeData=vt,t.isDuration=ri,t.monthsShort=vr,t.weekdaysMin=kr,t.defineLocale=gt,t.updateLocale=ht,t.locales=ft,t.weekdaysShort=br,t.normalizeUnits=ae,t.relativeTimeRounding=ts,t.relativeTimeThreshold=is,t.calendarFormat=Li,t.prototype=or,t.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},t}()),_l.exports),xl=bl(wl);let jl=class extends(qo(ce)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[],this.wateringCalendars=new Map,this.weatherRecords=new Map,this.isLoading=!0,this.isSaving=!1,this.isCreatingZone=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.zoneCache=new Map,this._expanded=new Set}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}_toggleZone(e){null!=e&&(this._expanded.has(e)?this._expanded.delete(e):this._expanded.add(e),this._scheduleUpdate())}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this.isCreatingZone?console.debug("Skipping data refresh during zone creation"):this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:je+"_config_updated"})]}async _fetchData(){if(this.hass)try{this._hasLoadedOnce||(this.isLoading=!0);const[e,a,t,i]=await Promise.all([Lo(this.hass),Bo(this.hass),Ro(this.hass),Uo(this.hass)]);this.config=e,this.zones=a,this.modules=t,this.mappings=i,this._fetchWateringCalendars(),this._fetchWeatherRecords(),this.zoneCache.clear()}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{calculate_all:!0})).catch((e=>{console.error("Failed to calculate all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{update_all:!0})).catch((e=>{console.error("Failed to update all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleResetAllBuckets(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{reset_all_buckets:!0})).catch((e=>{console.error("Failed to reset all buckets:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleClearAllWeatherdata(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{clear_all_weatherdata:!0})).catch((e=>{console.error("Failed to clear all weather data:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleAddZone(){if(!this.nameInput.value.trim())return;this.isCreatingZone=!1;const e={name:this.nameInput.value.trim(),size:parseFloat(this.sizeInput.value)||0,throughput:parseFloat(this.throughputInput.value)||0,state:fl.Automatic,duration:0,bucket:0,module:void 0,delta:0,et_deficiency:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0,drainage_rate:void 0,current_drainage:0};this.zones=[...this.zones,e],this.isSaving=!0,this.saveToHA(e).then((()=>(this.nameInput.value="",this.sizeInput.value="",this.throughputInput.value="",this._fetchData()))).catch((e=>{console.error("Failed to add zone:",e),this.zones=this.zones.slice(0,-1)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditZone(e,a){this.hass&&(this.zones[e]=a,a.id&&this.zoneCache.delete(a.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout((()=>{this.isSaving=!0,this._suppressNextConfigUpdate=!0,this.saveToHA(a).catch((e=>{this._suppressNextConfigUpdate=!1,console.error("Failed to save zone:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})),this.globalDebounceTimer=null}),500),this._scheduleUpdate())}handleRemoveZone(e,a){if(!this.hass)return;const t=this.zones[a].id;if(!this.zones[a]||null==t)return;const i=[...this.zones];var n,r;this.zones=this.zones.filter(((e,t)=>t!==a)),this.zoneCache.delete(t.toString()),this.isSaving=!0,(n=this.hass,r=t.toString(),n.callApi("POST",je+"/zones",{id:r,remove:!0})).catch((e=>{console.error("Failed to delete zone:",e),this.zones=i,this._fetchData().catch((e=>{console.error("Failed to refresh data after delete error:",e)}))})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleCalculateZone(e){const a=this.zones[e];var t,i;a&&null!=a.id&&(this.hass&&(t=this.hass,i=a.id.toString(),t.callApi("POST",je+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const a=this.zones[e];var t,i;a&&null!=a.id&&(this.hass&&(t=this.hass,i=a.id.toString(),t.callApi("POST",je+"/zones",{id:i,update:!0})))}handleViewWeatherInfo(e){var a;const t=this.zones[e];if(!t||null==t.mapping)return;const i=`#weather-section-${t.id}`,n=null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}handleViewWateringCalendar(e){var a;const t=this.zones[e];if(!t||null==t.id)return;const i=`#calendar-section-${t.id}`,n=null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}async _fetchWeatherRecords(){if(this.hass){for(const e of this.zones)if(void 0!==e.id&&void 0!==e.mapping)try{const a=await Vo(this.hass,e.mapping.toString(),10);this.weatherRecords.set(e.id,a)}catch(a){console.error(`Failed to fetch weather records for zone ${e.id} (mapping ${e.mapping}):`,a)}this._scheduleUpdate()}}async _fetchWateringCalendars(){if(this.hass){for(const t of this.zones)if(void 0!==t.id)try{const i=await(e=this.hass,a=t.id.toString(),e.callWS({type:je+"/watering_calendar",zone_id:a}));this.wateringCalendars.set(t.id,i)}catch(e){console.error(`Failed to fetch watering calendar for zone ${t.id}:`,e)}var e,a;this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass||"number"!=typeof e.id)return q``;const a=this.weatherRecords.get(e.id)||[];return q`
    ...
    `}renderWateringCalendar(e){if(!this.hass||"number"!=typeof e.id)return q``;const a=this.wateringCalendars.get(e.id),t=a&&e.id in a?a[e.id]:null,i=(null==t?void 0:t.monthly_estimates)||[];return q` <div class="watering-calendar">
      ...
      ${0===i.length?q`
          ...
          `:q` <div class="calendar-table">
            ...
            ${(null==t?void 0:t.calculation_method)?q`
                ...
                `:""}`}
    </div>`}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");var a,t;await(a=this.hass,t=e,a.callApi("POST",je+"/zones",t))}handleZoneFormFocus(){this.isCreatingZone=!0}handleZoneFormBlur(){var e,a,t,i;(null===(a=null===(e=this.nameInput)||void 0===e?void 0:e.value)||void 0===a?void 0:a.trim())||(null===(t=this.sizeInput)||void 0===t?void 0:t.value)||(null===(i=this.throughputInput)||void 0===i?void 0:i.value)||(this.isCreatingZone=!1)}renderTheOptions(e,a){if(this.hass){let t=q`<option value="" ?selected=${void 0===a}">---${$o("common.labels.select",this.hass.language)}---</option>`;return Object.entries(e).map((([e,i])=>t=q`${t}
            <option
              value="${i.id}"
              ?selected="${a===i.id}"
            >
              ${i.id}: ${i.name}
            </option>`)),t}return q``}renderZone(e,a){var t,i,n;if(!this.hass)return q``;const r=this.hass.language,s=e.state===fl.Automatic,o=e.state===fl.Disabled||e.state===fl.Automatic,l=null!=e.explanation&&e.explanation.length>0;if(null!=e.mapping){const a=this.mappings.filter((a=>a.id===e.mapping))[0];null!=a&&null!=a.data&&(e.number_of_data_points=a.data.length)}const d=$o("panels.zones.labels.states."+e.state,r),u=Co(e.duration,r),c=null!=e.id&&this._expanded.has(e.id);return q`
      <ha-card class="zone-card">
        ...
        ${c?q` <div class="zone-body">
              <div class="zone-meta">
                <div class="meta-item">
                  <span class="meta-label"
                    >${$o("panels.zones.labels.last_calculated",r)}</span
                  >
                ...
                <div class="meta-item">
                  <span class="meta-label"
                    >${$o("panels.zones.labels.data-last-updated",r)}</span
                  >
                  <span class="meta-value"
                ...
                <div class="meta-item">
                  <span class="meta-label"
                    >${$o("panels.zones.labels.data-number-of-data-points",r)}</span
                  >
                  <span class="meta-value"
              ...
              <div class="settings">
                ${this._textRow($o("panels.zones.labels.name",r),"",e.name,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ua]:t}))))}
                ${this._numRow($o("panels.zones.labels.size",r),Po(this.config,ca),e.size,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ca]:parseFloat(t)}))),.1)}
                ${this._numRow($o("panels.zones.labels.throughput",r),Po(this.config,pa),e.throughput,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[pa]:parseFloat(t)}))),.1)}
                ${this._numRow($o("panels.zones.labels.drainage_rate",r),Po(this.config,za),e.drainage_rate,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[za]:parseFloat(t)}))),.1)}
                ${this._selectRow($o("panels.zones.labels.state",r),q`
                    <option
                      value="${fl.Automatic}"
                      ?selected=${e.state===fl.Automatic}
                    >
                      ${$o("panels.zones.labels.states.automatic",r)}
                    </option>
                    <option
                      value="${fl.Disabled}"
                      ?selected=${e.state===fl.Disabled}
                    >
                      ${$o("panels.zones.labels.states.disabled",r)}
                    </option>
                    <option
                      value="${fl.Manual}"
                      ?selected=${e.state===fl.Manual}
                    >
                      ${$o("panels.zones.labels.states.manual",r)}
                    </option>
                  `,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ma]:t.target.value,[ga]:0}))))}
                ${this._selectRow($o("common.labels.module",r),this.renderTheOptions(this.modules,e.module),(t=>{const i=t.target.value;this.handleEditZone(a,Object.assign(Object.assign({},e),{[ha]:""===i?void 0:parseInt(i)}))}))}
                ${this._selectRow($o("panels.zones.labels.mapping",r),this.renderTheOptions(this.mappings,e.mapping),(t=>{const i=t.target.value;this.handleEditZone(a,Object.assign(Object.assign({},e),{[ba]:""===i?void 0:parseInt(i)}))}))}
                ${this._numRow($o("panels.zones.labels.bucket",r),Po(this.config,va),Number(e.bucket).toFixed(1),(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[va]:parseFloat(t)}))),.1)}
                ${this._numRow($o("panels.zones.labels.maximum-bucket",r),Po(this.config,va),Number(e.maximum_bucket).toFixed(1),(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[_a]:parseFloat(t)}))),.1)}
                ${this._numRow($o("panels.zones.labels.et-deficiency",r),Po(this.config,va),null!=e.et_deficiency?Number(e.et_deficiency).toFixed(2):"",(()=>{}),.01,!0)}
                ${(null===(i=this.config)||void 0===i?void 0:i.observed_watering_enabled)?this._entityRow($o("panels.zones.labels.linked-entity",r),$o("panels.zones.labels.optional",r),e.linked_entity,["switch","valve","input_boolean","binary_sensor"],(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[wa]:t||void 0}))),$o("panels.zones.labels.linked-entity-hint",r)):""}
                ${(null===(n=this.config)||void 0===n?void 0:n.observed_watering_enabled)&&e.linked_entity?this._entityRow($o("panels.zones.labels.flow-sensor",r),$o("panels.zones.labels.optional",r),e.flow_sensor,["sensor"],(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[xa]:t||void 0}))),$o("panels.zones.labels.flow-sensor-hint",r)):""}
                ${this._numRow($o("panels.zones.labels.lead-time",r),"s",e.lead_time,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ka]:parseInt(t,10)}))),1)}
                ${this._numRow($o("panels.zones.labels.maximum-duration",r),"s",e.maximum_duration,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ya]:parseInt(t,10)}))),1)}
                ${this._numRow($o("panels.zones.labels.multiplier",r),"",e.multiplier,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[fa]:parseFloat(t)}))),.1)}
                ${this._numRow($o("panels.zones.labels.duration",r),"s",e.duration,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ga]:parseInt(t,10)}))),1,o)}
              </div>

              <div class="zone-actions">
                ${s?q`
                      ${this._actionBtn(Fo,$o("panels.zones.actions.calculate",r),(()=>this.handleCalculateZone(a)))}
                      ${this._actionBtn(el,$o("panels.zones.actions.update",r),(()=>this.handleUpdateZone(a)))}
                    `:""}
                ${this._actionBtn(Qo,$o("panels.zones.actions.reset-bucket",r),(()=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[va]:0}))))}
                ${null!=e.mapping?this._actionBtn(Yo,$o("panels.zones.actions.view-weather-info",r),(()=>this.handleViewWeatherInfo(a))):""}
                ${this._actionBtn("M19,19H5V8H19M16,1V3H8V1H6V3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3H18V1M17,12H12V17H17V12Z",$o("panels.zones.actions.view-watering-calendar",r),(()=>this.handleViewWateringCalendar(a)))}
                ${l?this._actionBtn("M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z",$o("panels.zones.actions.information",r),(()=>this.toggleExplanation(a))):""}
                ${this._actionBtn(Zo,$o("common.actions.delete",r),(e=>this.handleRemoveZone(e,a)),!0)}
              </div>

              ${l?q`<label class="hidden" id="calcresults${a}"
                    >${Oo("<br/>"+e.explanation)}</label
                  >`:""}
    ...
    `}toggleExplanation(e){var a;const t=null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector("#calcresults"+e);t&&("hidden"!=t.className?t.className="hidden":t.className="explanation")}render(){return this.hass?this.isLoading?q`
        <ha-card header="${$o("panels.zones.title",this.hass.language)}">
          <div class="card-content">
            ${$o("common.loading-messages.general",this.hass.language)}...
          </div>
        </ha-card>
      ...
      <ha-card header="${$o("panels.zones.title",this.hass.language)}">
        <div class="card-content">
          ${$o("panels.zones.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${$o("panels.zones.cards.add-zone.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${$o("panels.zones.labels.name",this.hass.language)}
            </div>
            <input
              id="nameInput"
              class="field"
          ...
          <div class="setting-row">
            <div class="setting-label">
              ${$o("panels.zones.labels.size",this.hass.language)}
              <span class="unit">(${Po(this.config,ca)})</span>
            </div>
            <input
              id="sizeInput"
              class="field"
          ...
          <div class="setting-row">
            <div class="setting-label">
              ${$o("panels.zones.labels.throughput",this.hass.language)}
              <span class="unit"
                >(${Po(this.config,pa)})</span
              >
            </div>
            <input
              id="throughputInput"
          ...
          <div class="add-zone-actions">
            ...
            >
              ...
              ${this.isSaving?$o("common.saving-messages.adding",this.hass.language):$o("panels.zones.cards.add-zone.actions.add",this.hass.language)}
            </ha-button>
          </div>
        </div>
      </ha-card>
      ...
      <ha-card
        header="${$o("panels.zones.cards.zone-actions.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="zone-actions-grid">
            ${this._actionBtn(Fo,$o("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language),(()=>this.handleCalculateAllZones()),!1,this.isSaving)}
            ${this._actionBtn(el,$o("panels.zones.cards.zone-actions.actions.update-all",this.hass.language),(()=>this.handleUpdateAllZones()),!1,this.isSaving)}
            ${this._actionBtn(Qo,$o("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language),(()=>this.handleResetAllBuckets()),!1,this.isSaving)}
            ${this._actionBtn(Yo,$o("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language),(()=>this.handleClearAllWeatherdata()),!1,this.isSaving)}
          </div>
        </div>
      </ha-card>
        ...
        ${s?q` <div class="si-body">
              <div class="moduleconfig">
                <label class="subheader"
                  >${$o("panels.modules.cards.module.labels.configuration",this.hass.language)}
                  (*
                  ${$o("panels.modules.cards.module.labels.required",this.hass.language)})</label
                >
                <div class="settings">
              ...
              ${n?q`<div class="weather-note">
                    ${$o("panels.modules.cards.module.errors.cannot-delete-module-because-zones-use-it",this.hass.language)}
                  </div>`:q`<div class="si-actions">
                    ${this._actionBtn(Zo,$o("common.actions.delete",this.hass.language),(e=>this.handleRemoveModule(e,a)),!0)}
                  </div>`}
            </div>`:""}
      </ha-card>
    `;return this.moduleCache.set(l,d),d}renderConfig(e,a){const t=Object.values(this.modules).at(e);if(!t||!this.hass)return;const i=t.schema[a],n=i.name,r=function(e){if(e)return(e=e.replace("_"," ")).charAt(0).toUpperCase()+e.slice(1)}(n);let s="";null==t.config&&(t.config=[]),n in t.config&&(s=t.config[n]);const o=i.required?`${r} *`:null!=r?r:"";if("boolean"==i.type)return q`
      ...
      `;if("float"==i.type||"integer"==i.type)return this._numRow(o,"",t.config[n],(a=>this.handleEditConfig(e,Object.assign(Object.assign({},t),{config:Object.assign(Object.assign({},t.config),{[n]:a})}))),1);if("string"==i.type)return this._textRow(o,"",s,(a=>this.handleEditConfig(e,Object.assign(Object.assign({},t),{config:Object.assign(Object.assign({},t.config),{[n]:a})}))));if("select"==i.type){const a=this.hass.language,r=q`
        ${Object.entries(i.options).map((([e,t])=>q`<option
              ...
              ?selected="${s===No(t,0)}"
            >
              ${$o("panels.modules.cards.module.translated-options."+No(t,1),a)}
            </option>`))}
    ...
    `}handleEditConfig(e,a){this.modules=Object.values(this.modules).map(((t,i)=>i===e?a:t)),this.moduleCache.clear(),this._scheduleUpdate(),this.debouncedSave(a)}renderOption(e,a){return this.hass?q`<option value="${e}>${a}</option>`:q``}render(){return this.hass?q`
      <ha-card header="${$o("panels.modules.title",this.hass.language)}">
        <div class="card-content">
          ${$o("panels.modules.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${$o("panels.modules.cards.add-module.header",this.hass.language)}"
      >
        <div class="card-content">
          ${this.isLoading?q`<div class="loading-indicator">
                ...
                <div class="setting-row">
                  <div class="setting-label">
                    ${$o("common.labels.module",this.hass.language)}
                  </div>
                  <div class="select-wrap">
                    <select
                      id="moduleInput"
                ...
                <div class="si-form-actions">
                  ...
                  >
                    <ha-svg-icon slot="start" .path=${Xo}></ha-svg-icon>
                    ${this.isSaving?$o("common.saving-messages.adding",this.hass.language):$o("panels.modules.cards.add-module.actions.add",this.hass.language)}
                  </ha-button>
                </div>
              `}
        </div>
      ...
      ${this.isLoading?q`<div class="loading-indicator">
            ${$o("common.loading-messages.modules",this.hass.language)}
    ...
    `:q``}disconnectedCallback(){super.disconnectedCallback(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.moduleCache.clear()}static get styles(){return p`
      ${tl} ${rl} /* View-specific styles only - most common styles are now in globalStyle */
    `}};r([he()],Sl.prototype,"config",void 0),r([he({type:Array})],Sl.prototype,"zones",void 0),r([he({type:Array})],Sl.prototype,"modules",void 0),r([he({type:Array})],Sl.prototype,"allmodules",void 0),r([he({type:Boolean})],Sl.prototype,"isLoading",void 0),r([he({type:Boolean})],Sl.prototype,"isSaving",void 0),r([fe("#moduleInput")],Sl.prototype,"moduleInput",void 0),Sl=r([me("smart-irrigation-view-modules")],Sl);let Al=class extends(qo(ce)){constructor(){super(...arguments),this.zones=[],this.mappings=[],this.weatherRecords=new Map,this.isLoading=!0,this.isSaving=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this.debounceTimers=new Map,this.globalDebounceTimer=null,this.mappingCache=new Map,this._updateScheduled=!1,this._lastUpdateTime=0,this._updateThrottleDelay=16,this._expanded=new Set}_scheduleUpdate(){if(this._updateScheduled)return;const e=performance.now()-this._lastUpdateTime;e<this._updateThrottleDelay?setTimeout((()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()}),this._updateThrottleDelay-e):(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()})))}_toggleItem(e){null!=e&&(this._expanded.has(e)?this._expanded.delete(e):this._expanded.add(e),this._scheduleUpdate())}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:je+"_config_updated"})]}async _fetchData(){var e;if(this.hass)try{this._hasLoadedOnce||(this.isLoading=!0);const[e,a,t]=await Promise.all([Lo(this.hass),Bo(this.hass),Uo(this.hass)]);this.config=e,this.zones=a,this.mappings=t,this._fetchWeatherRecords(),this.mappingCache.clear()}catch(a){console.error("Error fetching data:",a),Ho({body:{message:"Failed to load mapping data"},error:"Data fetch error"},null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("ha-card"))}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}}async _fetchWeatherRecords(){if(this.hass){for(const e of this.mappings)if(void 0!==e.id)try{const a=await Vo(this.hass,e.id.toString(),10);this.weatherRecords.set(e.id,a)}catch(a){console.error(`Failed to fetch weather records for mapping ${e.id}:`,a),this.weatherRecords.set(e.id,[])}this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass)return q``;const a=void 0!==e.id&&this.weatherRecords.get(e.id)||[];return q`
      <div class="weather-records">
        <h4>
          ${$o("panels.mappings.weather-records.title",this.hass.language)}
        </h4>
        ...
        <div class="card-content">
          <div class="card-content">
            ...
            ${i?q`<div class="weather-note">
                  ${$o("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",this.hass.language)}
                </div>`:q` <div
                  class="action-button"
                ...
                >
                  ...
                  <span class="action-button-label">
                    ${$o("common.actions.delete",this.hass.language)}
                  </span>
                </div>`}
          </div>
        </div>
    ...
    `;return this.mappingCache.set(t,n),n}renderMappingSetting(e,a){const t=this.mappings[e];if(!t||!this.hass)return q``;const i=t.mappings[a];return q`
      <div class="si-subgroup">
        <div class="si-subgroup-title">
          ${$o(`panels.mappings.cards.mapping.items.${a.toLowerCase()}`,this.hass.language)}
        </div>
        ${this._selectRow($o("panels.mappings.cards.mapping.source",this.hass.language),this.renderSimpleRadioOptions(e,a,i),(t=>this.handleSimpleSourceChange(e,a,t)))}
        ${this.renderMappingInputs(e,a,i)}
      </div>
    `}renderSimpleRadioOptions(e,a,t){if(!this.hass||!this.config)return q``;const i=a===Le||a===qe,n=t[ta],r=!!this.config.use_weather_service,s=i&&this.config.weather_service!==Ge;return q`
      ${r?q`<option
            value="${Ze}"
            ?selected=${n===Ze}
          >
            ${$o("panels.mappings.cards.mapping.sources.weather_service",this.hass.language)}${s?" (via Open-Meteo)":""}
          </option>`:""}
      ${i?q`<option
            value="${aa}"
            ?selected=${n===aa}
          >
            ${$o("panels.mappings.cards.mapping.sources.none",this.hass.language)}
          </option>`:""}
      <option
        value="${Ke}"
        ?selected=${n===Ke}
      >
        ${$o("panels.mappings.cards.mapping.sources.sensor",this.hass.language)}
      </option>
      <option
        value="${Je}"
        ?selected=${n===Je}
      >
        ${$o("panels.mappings.cards.mapping.sources.static",this.hass.language)}
      </option>
    `}handleSimpleSourceChange(e,a,t){const i=this.mappings[e],n=t.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[a]:Object.assign(Object.assign({},i.mappings[a]),{[ta]:n,[ia]:""})})}))}handleSimpleInputChange(e,a,t,i){const n=this.mappings[e],r=i.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},n),{mappings:Object.assign(Object.assign({},n.mappings),{[a]:Object.assign(Object.assign({},n.mappings[a]),{[t]:r})})}))}renderSourceOptions(e,a,t){var i;if(!this.hass)return q``;const n=`${a}_${e}`,r=a===Le||a===qe,s=!!(null===(i=this.config)||void 0===i?void 0:i.use_weather_service);return q`
      <div class="mappingsettingline">
        <label for="${n}_source">
          ${$o("panels.mappings.cards.mapping.source",this.hass.language)}:
        </label>
      </div>
    ...
    `}renderWeatherServiceOption(e,a,t){if(!this.hass||!this.config)return q``;const i=`${a}_${e}`,n=!this.config.use_weather_service,r=this.config.use_weather_service&&t[ta]===Ze,s=(a===Le||a===qe)&&this.config.weather_service!==Ge;return q`
    ...
    `}renderNoneOption(e,a,t){if(!this.hass)return q``;const i=`${a}_${e}`,n=t[ta]===aa;return q`
      <label>
        <input
          type="radio"
          id="${i}_none"
    ...
    `}renderSensorOption(e,a,t){if(!this.hass)return q``;const i=`${a}_${e}`,n=t[ta]===Ke;return q`
      <label>
        <input
          type="radio"
          id="${i}_sensor"
    ...
    `}renderStaticValueOption(e,a,t){if(!this.hass)return q``;const i=`${a}_${e}`,n=t[ta]===Je;return q`
      <label>
        <input
          type="radio"
          id="${i}_static"
    ...
    `}handleSourceChange(e,a,t){const i=this.mappings[e],n=t.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[a]:Object.assign(Object.assign({},i.mappings[a]),{[ta]:n,[ia]:""})})}))}renderMappingInputs(e,a,t){if(!this.hass)return q``;const i=t[ta];return q`
      ${i===Ke?this.renderSensorInput(e,a,t):""}
      ${i===Je?this.renderStaticValueInput(e,a,t):""}
      ${i===Ke||i===Je?this.renderUnitSelect(e,a,t):""}
      ${a!==Ve||i!==Ke&&i!==Je?"":this.renderPressureTypeSelect(e,a,t)}
      ${i===Ke?this.renderAggregateSelect(e,a,t):""}
    `}renderSensorInput(e,a,t){return this.hass?q`
      <div class="setting-row">
        <div class="setting-label">
          ${$o("panels.mappings.cards.mapping.sensor-entity",this.hass.language)}
        </div>
        <ha-entity-picker
          class="entity-field"
          .hass=${this.hass}
    ...
    `:q``}renderStaticValueInput(e,a,t){return this.hass?this._numRow($o("panels.mappings.cards.mapping.static_value",this.hass.language),"",t[na]||"",(t=>this.handleStaticValueChange(e,a,{target:{value:t}})),.1):q``}renderUnitSelect(e,a,t){return this.hass&&this.config?this._selectRow($o("panels.mappings.cards.mapping.input-units",this.hass.language),this.renderUnitOptionsForMapping(a,t),(t=>this.handleUnitChange(e,a,t))):q``}renderPressureTypeSelect(e,a,t){return this.hass?this._selectRow($o("panels.mappings.cards.mapping.pressure-type",this.hass.language),this.renderPressureTypes(a,t),(t=>this.handlePressureTypeChange(e,a,t))):q``}renderAggregateSelect(e,a,t){return this.hass?q`
      <div class="setting-row">
        <div class="setting-label">
          ${$o("panels.mappings.cards.mapping.sensor-aggregate-use-the",this.hass.language)}
          <span class="unit"
            >${$o("panels.mappings.cards.mapping.sensor-aggregate-of-sensor-values-to-calculate",this.hass.language)}</span
          >
        </div>
        <div class="select-wrap">
          <select
    ...
    `:q``}handleSensorChange(e,a,t){const i=this.mappings[e];this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[a]:Object.assign(Object.assign({},i.mappings[a]),{[ia]:t.target.value})})}))}handleStaticValueChange(e,a,t){const i=this.mappings[e];this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[a]:Object.assign(Object.assign({},i.mappings[a]),{[na]:t.target.value})})}))}handleUnitChange(e,a,t){const i=this.mappings[e];this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[a]:Object.assign(Object.assign({},i.mappings[a]),{[ra]:t.target.value})})}))}handlePressureTypeChange(e,a,t){const i=this.mappings[e];this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[a]:Object.assign(Object.assign({},i.mappings[a]),{[Qe]:t.target.value})})}))}handleAggregateChange(e,a,t){const i=this.mappings[e];this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[a]:Object.assign(Object.assign({},i.mappings[a]),{[sa]:t.target.value})})}))}renderAggregateOptionsForMapping(e,a){if(!this.hass||!this.config)return q``;let t="average";return e===Re&&(t="delta"),e===Ue&&(t="average"),a[sa]&&(t=a[sa]),q`
      ${oa.map((e=>this.renderAggregateOption(e,t)))}
    `}renderAggregateOption(e,a){if(this.hass&&this.config){return q`<option value="${e}" ?selected="${e===a}">
        ${$o("panels.mappings.cards.mapping.aggregates."+e,this.hass.language)}
      </option>`}return q``}renderPressureTypes(e,a){if(this.hass&&this.config){let e=q``;const t=a[Qe];return e=q`${e}
        <option
          value="${Xe}"
          ?selected="${t===Xe}"
        >
          ${$o("panels.mappings.cards.mapping.pressure_types."+Xe,this.hass.language)}
        </option>
        <option
          value="${ea}"
          ?selected="${t===ea}"
        >
          ${$o("panels.mappings.cards.mapping.pressure_types."+ea,this.hass.language)}
        </option>`,e}return q``}renderUnitOptionsForMapping(e,a){if(!this.hass||!this.config)return q``;const t=function(e){switch(e){case Ie:case Fe:return[{unit:"°C",system:He},{unit:"°F",system:Ce}];case Re:case Le:return[{unit:"mm",system:He},{unit:"in",system:Ce}];case Ue:return[{unit:la,system:He},{unit:da,system:Ce}];case Be:return[{unit:"%",system:[He,Ce]}];case Ve:return[{unit:"millibar",system:He},{unit:"hPa",system:He},{unit:"psi",system:Ce},{unit:"inch Hg",system:Ce}];case We:return[{unit:"km/h",system:He},{unit:"meter/s",system:He},{unit:"mile/h",system:Ce}];case qe:return[{unit:"W/m2",system:He},{unit:"MJ/day/m2",system:He},{unit:"W/sq ft",system:Ce},{unit:"MJ/day/sq ft",system:Ce}];default:return[]}}(e);let i=a[ra];const n=this.config.units;if(!a[ra])for(const e of t)if("string"==typeof e.system){if(n===e.system){i=e.unit;break}}else{for(const a of e.system)if(n===a.system){i=e.unit;break}if(i===e.unit)break}return q`
      ${t.map((e=>q`
    ...
    `}render(){return this.hass?this.isLoading?q`
        <ha-card
          header="${$o("panels.mappings.title",this.hass.language)}"
        >
          <div class="card-content">
            ${$o("common.loading-messages.general",this.hass.language)}
          </div>
      ...
      >
        <div class="card-content">
          ${$o("panels.mappings.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${$o("panels.mappings.cards.add-mapping.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${$o("panels.mappings.labels.mapping-name",this.hass.language)}
            </div>
          ...
          <div class="si-form-actions">
            ...
            >
              <ha-svg-icon slot="start" .path=${Xo}></ha-svg-icon>
              ${this.isSaving?$o("common.saving-messages.adding",this.hass.language):$o("panels.mappings.cards.add-mapping.actions.add",this.hass.language)}
            </ha-button>
          </div>
        </div>
      </ha-card>
    ...
    `:q``}renderMappingsList(){const e=this.mappings.slice(0,Math.min(this.mappings.length,10)),a=this.mappings.slice(10);return q`
      ...
      ${a.length>0?q`
          ...
          `:""}
    `}renderMappingCard(e,a){if(!this.hass)return q``;const t=this.hass.language,i=this.zones.filter((a=>a.mapping===e.id)).length,n=Object.keys(e.mappings||{}).length,r=[];r.push(`${n} ${$o("panels.mappings.title",t).toLowerCase()}`),i&&r.push(`${i} ${$o("panels.zones.title",t).toLowerCase()}`);const s=r.join(" · "),o=null!=e.id&&this._expanded.has(e.id);return q`
      <ha-card class="si-card">
        <div
          class="si-head"
          role="button"
        ...
        ${o?q`<div class="si-body">
              <div class="settings">
                ${this._textRow($o("panels.mappings.labels.mapping-name",t),"",e.name,(t=>this.handleEditMapping(a,Object.assign(Object.assign({},e),{name:t}))))}
                ${this.renderMappingSettings(e,a)}
              </div>
              ${this.renderWeatherRecords(e)}
              <div class="si-actions">
                ${i?q`<div class="weather-note">
                      ${$o("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",t)}
                    </div>`:this._actionBtn(Zo,$o("common.actions.delete",t),(e=>this.handleRemoveMapping(e,a)),!0)}
              </div>
            </div>`:""}
      </ha-card>
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach((e=>{clearTimeout(e)})),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear()}};r([he()],Al.prototype,"config",void 0),r([he({type:Array})],Al.prototype,"zones",void 0),r([he({type:Array})],Al.prototype,"mappings",void 0),r([he({type:Map})],Al.prototype,"weatherRecords",void 0),r([he({type:Boolean})],Al.prototype,"isLoading",void 0),r([he({type:Boolean})],Al.prototype,"isSaving",void 0),r([fe("#mappingNameInput")],Al.prototype,"mappingNameInput",void 0),Al=r([me("smart-irrigation-view-mappings")],Al);let $l=class extends ce{constructor(){super(...arguments),this._use=!1,this._service=null,this._apiKey="",this._loading=!0,this._saving=!1,this._error="",this._saved=!1}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)})),this._load()}async _load(){var e;if(this.hass)try{const a=await(e=this.hass,e.callWS({type:je+"/weatherservice"}));this._info=a,this._use=!!a.use_weather_service,this._service=a.weather_service||(a.services&&a.services.includes(Ge)?Ge:a.services&&a.services.length?a.services[0]:null),this._apiKey=a.weather_service_api_key||"",this._error=""}catch(e){this._error=this._errText(e)}finally{this._loading=!1}}_errText(e){return e&&(e.message||e.code)?e.message||e.code:String(e)}async _save(){if(this.hass){this._saving=!0,this._error="",this._saved=!1;try{await(e=this.hass,a={use_weather_service:this._use,weather_service:this._use?this._service:null,weather_service_api_key:this._use?this._apiKey:null},e.callWS(Object.assign({type:je+"/set_weatherservice"},a))),this._saved=!0,window.setTimeout((()=>this._load()),800)}catch(e){this._error=this._errText(e)}finally{this._saving=!1}var e,a}}render(){var e;if(!this.hass)return q``;const a=this.hass.language;return this._loading&&!this._info?q`
        <ha-card header="${$o("panels.weatherservice.title",a)}">
          <div class="card-content">
            ${$o("common.loading-messages.general",a)}...
          </div>
        </ha-card>
      `:q`
      <ha-card header="${$o("panels.weatherservice.title",a)}">
        <div class="card-content ws-description">
          ${$o("panels.weatherservice.description",a)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${$o("panels.weatherservice.labels.use-weather-service",a)}
            </div>
            <ha-switch
              .checked=${this._use}
          ...
          ${this._use?q`
                <div class="setting-row">
                  <div class="setting-label">
                    ${$o("panels.weatherservice.labels.service",a)}
                  </div>
                  <div class="select-wrap">
                    <select
                      class="field"
                ...
                ${this._service&&Ye.includes(this._service)?"":q`<div class="setting-row">
                      <div class="setting-label">
                        ${$o("panels.weatherservice.labels.api-key",a)}
                      </div>
                      <input
                        class="field"
                        type="text"
                ...
                ${"Open Weather Map"===this._service?q`<div class="ws-note ws-note--hint">
                      ${$o("panels.weatherservice.messages.owm-onecall-hint",a)}
                    </div>`:""}
              `:q`<div class="ws-note">
                ${$o("panels.weatherservice.messages.no-service",a)}
              </div>`}
          ${this._error?q`<div class="ws-msg ws-msg--error">${this._error}</div>`:""}
          ${this._saved?q`<div class="ws-msg ws-msg--success">
                ${$o("panels.weatherservice.messages.saved",a)}
              </div>`:""}
          ...
          <div class="ws-actions">
            <ha-button
              ...
              @click=${this._save}
            >
              ${this._saving?$o("panels.weatherservice.actions.saving",a):$o("panels.weatherservice.actions.save",a)}
            </ha-button>
          </div>
          <div class="ws-note ws-reload-note">
            ${$o("panels.weatherservice.messages.reload-note",a)}
          </div>
        </div>
      </ha-card>
    `}static get styles(){return p`
    ...
    `}};r([he()],$l.prototype,"narrow",void 0),r([he()],$l.prototype,"path",void 0),r([ve()],$l.prototype,"_info",void 0),r([ve()],$l.prototype,"_use",void 0),r([ve()],$l.prototype,"_service",void 0),r([ve()],$l.prototype,"_apiKey",void 0),r([ve()],$l.prototype,"_loading",void 0),r([ve()],$l.prototype,"_saving",void 0),r([ve()],$l.prototype,"_error",void 0),r([ve()],$l.prototype,"_saved",void 0),$l=r([me("smart-irrigation-view-weatherservice")],$l);let El=class extends ce{constructor(){super(...arguments),this._busy=!1,this._error="",this._message="",this._pendingName=""}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}_errText(e){return e&&(e.message||e.code)?e.message||e.code:String(e)}_reset(){this._error="",this._message="",this._pending=void 0,this._pendingName=""}async _export(){if(this.hass){this._reset(),this._busy=!0;try{const a=await(e=this.hass,e.callApi("GET",je+"/export")),t=JSON.stringify(a,null,2),i=new Blob([t],{type:"application/json"}),n=URL.createObjectURL(i),r=document.createElement("a");r.href=n;const s=(new Date).toISOString().slice(0,19).replace("T","_").replace(/:/g,"-");r.download=`smart_irrigation_backup_${s}.json`,r.click(),URL.revokeObjectURL(n),this._message=$o("panels.backuprestore.messages.exported",this.hass.language)}catch(e){this._error=this._errText(e)}finally{this._busy=!1}var e}}async _onFile(e){this._reset();const a=e.target,t=a.files&&a.files[0];if(t)try{const e=await t.text(),a=JSON.parse(e);if(!a||"object"!=typeof a||!a.config)throw new Error($o("panels.backuprestore.messages.invalid-file",this.hass.language));this._pending=a,this._pendingName=t.name}catch(e){this._error=this._errText(e)}finally{a.value=""}}async _restore(){if(this.hass&&this._pending){this._busy=!0,this._error="",this._message="";try{const t=await(e=this.hass,a=this._pending,e.callApi("POST",je+"/restore",a));if(t&&!1===t.success)throw new Error(t.error||"restore failed");this._pending=void 0,this._pendingName="",this._message=$o("panels.backuprestore.messages.restored",this.hass.language)}catch(e){this._error=this._errText(e)}finally{this._busy=!1}var e,a}}_count(e){const a=this._pending&&this._pending[e];return Array.isArray(a)?a.length:0}render(){if(!this.hass)return q``;const e=this.hass.language;return q`
        ...
        <div class="card-content">
          ...
          <div class="br-actions">
            ...
            >
              ...
              ${$o("panels.backuprestore.actions.export",e)}
            </ha-button>
          </div>
        </div>
      </ha-card>
      ...
      <ha-card
        header="${$o("panels.backuprestore.cards.restore.title",e)}"
      >
        <div class="card-content">
          <div class="br-description">
            ${$o("panels.backuprestore.cards.restore.description",e)}
          </div>
          ...
          <label class="br-file">
            ...
            ${$o("panels.backuprestore.actions.choose-file",e)}
          </label>
                ...
                <div class="br-warning">
                  ...
                  <div>
                    <div class="br-warning-title">
                      ${$o("panels.backuprestore.messages.confirm-title",e)}
                    </div>
                    <div class="br-file-name">${this._pendingName}</div>
                    <div class="br-summary">
                      ${$o("panels.backuprestore.messages.summary",e)}:
                      ${this._count("zones")}
                      ${$o("panels.zones.title",e)} ·
                      ${this._count("modules")}
                      ${$o("panels.modules.title",e)} ·
                      ${this._count("mappings")}
                      ${$o("panels.mappings.title",e)}
                    </div>
                    <div class="br-warning-text">
                      ${$o("panels.backuprestore.messages.confirm-warning",e)}
                    </div>
                  </div>
                </div>
              `:""}
          ...
          ${this._pending?q`<div class="br-actions">
                ...
                >
                  ...
                  ${this._busy?$o("panels.backuprestore.actions.restoring",e):$o("panels.backuprestore.actions.restore",e)}
                </ha-button>
              </div>`:""}
          <div class="br-note">
            ${$o("panels.backuprestore.messages.reload-note",e)}
          </div>
        </div>
      </ha-card>
    `}static get styles(){return p`
    ...
    `}};r([he()],El.prototype,"narrow",void 0),r([he()],El.prototype,"path",void 0),r([ve()],El.prototype,"_busy",void 0),r([ve()],El.prototype,"_error",void 0),r([ve()],El.prototype,"_message",void 0),r([ve()],El.prototype,"_pending",void 0),r([ve()],El.prototype,"_pendingName",void 0),El=r([me("smart-irrigation-view-backuprestore")],El);let Tl=class extends(qo(ce)){constructor(){super(...arguments),this.zones=[],this.isLoading=!0,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:je+"_config_updated"})]}async _fetchData(){var e;if(this.hass)try{this.isLoading=!0;const[a,t,i]=await Promise.all([Lo(this.hass),(e=this.hass,e.callWS({type:je+"/info"})),Bo(this.hass)]);this.config=a,this.info=t,this.zones=i}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._scheduleUpdate()}}render(){return this.hass?this.isLoading?q`
        <ha-card header="${$o("panels.info.title",this.hass.language)}">
          <div class="card-content">
            ${$o("common.loading",this.hass.language)}...
          </div>
        </ha-card>
      `:this.config?q`
      <ha-card header="${$o("panels.info.title",this.hass.language)}">
        <div class="card-content">
          ${$o("panels.info.description",this.hass.language)}
        </div>
      </ha-card>
    ...
    `:q`
        <ha-card header="${$o("panels.info.title",this.hass.language)}">
          <div class="card-content">
            ${$o("panels.info.configuration-not-available",this.hass.language)}
          </div>
        </ha-card>
      `:q``}renderZoneBucketsCard(){if(!this.hass)return q``;if(!this.zones||0===this.zones.length)return q`
        <ha-card
          header="${$o("panels.info.cards.zone-bucket-values.title",this.hass.language)}"
        >
          <div class="card-content">
            <div class="info-item">
              <span class="value"
                >${$o("panels.info.cards.zone-bucket-values.no-zones",this.hass.language)}</span
              >
            </div>
          </div>
        </ha-card>
      `;const e=this.config?Po(this.config,va):"mm";return q`
      <ha-card
        header="${$o("panels.info.cards.zone-bucket-values.title",this.hass.language)}"
      >
        <div class="card-content">
              ...
              <div class="zone-info">
                ...
                <div class="zone-details">
                  <div class="zone-bucket">
                    <span class="label"
                      >${$o("panels.info.cards.zone-bucket-values.labels.bucket",null!==(i=null===(t=this.hass)||void 0===t?void 0:t.language)&&void 0!==i?i:"en")}:</span
                    >
                    <span class="value">
                  ...
                  <div class="zone-duration">
                    <span class="label"
                      >${$o("panels.info.cards.zone-bucket-values.labels.duration",null!==(r=null===(n=this.hass)||void 0===n?void 0:n.language)&&void 0!==r?r:"en")}:</span
                    >
                    <span class="value">
                      ${Co(a.duration,null!==(o=null===(s=this.hass)||void 0===s?void 0:s.language)&&void 0!==o?o:"en")}
                    </span>
                  </div>
                </div>
              </div>
    ...
    `}renderNextIrrigationCard(){var e,a,t,i,n,r,s,o;return this.hass&&this.info?q`
      <ha-card
        header="${$o("panels.info.cards.next-irrigation.title",this.hass.language)}"
      >
        <div class="card-content">
          <div class="info-item">
            <label
              >${$o("panels.info.cards.next-irrigation.labels.next-start",this.hass.language)}:</label
            >
            <span class="value">
              ${this.info.next_irrigation_start?xl(this.info.next_irrigation_start).format("YYYY-MM-DD HH:mm:ss"):$o("panels.info.cards.next-irrigation.no-data",this.hass.language)}
            </span>
          </div>
          ...
          ${this.info.next_irrigation_duration?q`
                <div class="info-item">
                  <label
                    >${$o("panels.info.cards.next-irrigation.labels.duration",this.hass.language)}:</label
                  >
                  <span class="value"
                    >${Co(this.info.next_irrigation_duration,this.hass.language)}</span
                  >
                </div>
              `:""}
          ${this.info.next_irrigation_zones&&this.info.next_irrigation_zones.length>0?q`
                <div class="info-item">
                  <label
                    >${$o("panels.info.cards.next-irrigation.labels.zones",this.hass.language)}:</label
                  >
                  <span class="value"
    ...
    `:q`
        <ha-card
          header="${$o("panels.info.cards.next-irrigation.title",null!==(a=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==a?a:"en")}"
        >
          <div class="card-content">
            <div class="info-item">
              <label
                >${$o("panels.info.cards.next-irrigation.labels.next-start",null!==(i=null===(t=this.hass)||void 0===t?void 0:t.language)&&void 0!==i?i:"en")}:</label
              >
              <span class="value">
                ${$o("panels.info.cards.next-irrigation.no-data",null!==(r=null===(n=this.hass)||void 0===n?void 0:n.language)&&void 0!==r?r:"en")}
              </span>
            </div>
            <div class="info-note">
              ${$o("panels.info.cards.next-irrigation.backend-todo",null!==(o=null===(s=this.hass)||void 0===s?void 0:s.language)&&void 0!==o?o:"en")}
            </div>
          </div>
        </ha-card>
      `}renderIrrigationReasonCard(){var e,a,t,i,n,r,s,o;return this.hass&&this.info?q`
      <ha-card
        header="${$o("panels.info.cards.irrigation-reason.title",this.hass.language)}"
      >
        <div class="card-content">
          <div class="info-item">
            <label
              >${$o("panels.info.cards.irrigation-reason.labels.reason",this.hass.language)}:</label
            >
            <span class="value">
              ${this.info.irrigation_reason||$o("panels.info.cards.irrigation-reason.no-data",this.hass.language)}
            </span>
          </div>
          ...
          ${this.info.sunrise_time?q`
                <div class="info-item">
                  <label
                    >${$o("panels.info.cards.irrigation-reason.labels.sunrise",this.hass.language)}:</label
                  >
                  <span class="value"
          ...
          ${void 0!==this.info.total_irrigation_duration?q`
                <div class="info-item">
                  <label
                    >${$o("panels.info.cards.irrigation-reason.labels.total-duration",this.hass.language)}:</label
                  >
                  <span class="value"
                    >${Co(this.info.total_irrigation_duration,this.hass.language)}</span
                  >
                </div>
              `:""}
          ${this.info.irrigation_explanation?q`
                <div class="info-item explanation">
                  <label
                    >${$o("panels.info.cards.irrigation-reason.labels.explanation",this.hass.language)}:</label
                  >
    ...
    `:q`
        <ha-card
          header="${$o("panels.info.cards.irrigation-reason.title",null!==(a=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==a?a:"en")}"
        >
          <div class="card-content">
            <div class="info-item">
              <label
                >${$o("panels.info.cards.irrigation-reason.labels.reason",null!==(i=null===(t=this.hass)||void 0===t?void 0:t.language)&&void 0!==i?i:"en")}:</label
              >
              <span class="value">
                ${$o("panels.info.cards.irrigation-reason.no-data",null!==(r=null===(n=this.hass)||void 0===n?void 0:n.language)&&void 0!==r?r:"en")}
              </span>
            </div>
            <div class="info-note">
              ${$o("panels.info.cards.irrigation-reason.backend-todo",null!==(o=null===(s=this.hass)||void 0===s?void 0:s.language)&&void 0!==o?o:"en")}
            </div>
          </div>
        </ha-card>
      `}static get styles(){return p`
      ...
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            ...
            .narrow=${this.narrow}
          ></ha-menu-button>
          <div class="main-title">${$o("title",this.hass.language)}</div>
          <div class="version">${"v2026.8.6"}</div>
        </div>
              ...
              <ha-tab-group @wa-tab-show=${this.handlePageSelected}>
                ${Object.values(Nl).map((a=>q`
                    <ha-tab-group-tab
                      ...
                      .active=${e.page===a}
                    >
                      ${$o(`panels.${a}.title`,this.hass.language)}
                    </ha-tab-group-tab>
                  `))}
              </ha-tab-group>
            `:q`
    ...
    `}getView(e){switch(e.page){case"info":return q`
        ...
        `;case"help":return q`<ha-card
          header="${$o("panels.help.cards.how-to-get-help.title",this.hass.language)}"
        >
          <div class="card-content">
            ${$o("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)}
            <a href="https://altmenorg.github.io/HAsmartirrigation/"
              >${$o("panels.help.cards.how-to-get-help.wiki",this.hass.language)}</a
            >.
            ${$o("panels.help.cards.how-to-get-help.if-you-still-need-help",this.hass.language)}
            <a
              href="https://community.home-assistant.io/t/smart-irrigation-save-water-by-precisely-watering-your-lawn-garden"
              >${$o("panels.help.cards.how-to-get-help.community-forum",this.hass.language)}</a
            >
            ${$o("panels.help.cards.how-to-get-help.or-open-a",this.hass.language)}
            <a href="https://github.com/altmenorg/HAsmartirrigation/issues"
              >${$o("panels.help.cards.how-to-get-help.github-issue",this.hass.language)}</a
            >
            (${$o("panels.help.cards.how-to-get-help.english-only",this.hass.language)}).
          </div></ha-card
        >`;default:return q`
        ...
        `}}navigateToPage(e){if(e!==Dl().page){const a=Ol(e);Io(0,a),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const a=e.detail.name;if(a!==Dl().page){const e=Ol(a);Io(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[Ml,p`
        :host {
          color: var(--primary-text-color);
